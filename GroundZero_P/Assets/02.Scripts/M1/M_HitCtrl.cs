...
public class M_HitCtrl : MonoBehaviour {
    ...
    public void OnHitMonster(int pDamage)
    {
        ...
        //가져온 데미지만큼 총 HP 차감
        GameObject.FindWithTag(Tags.Monster).GetComponent<MonsterCtrl>().HP -= hitDamage;
    ...
    IEnumerator ColoringRed()
    {
        ...
        GameObject.Find("MonsterModel").GetComponent<SkinnedMeshRenderer>().material.color = Color.white;
    }
    #endregion
}
